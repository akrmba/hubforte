...
- The public `main` history was replaced with a sanitized root snapshot. The old commit link may remain cached; request removal from GitHub Support.
- The maintainer confirmed resetting the Neon database password on 2026-09-25. Applications using it still need their environment secrets updated with the replacement.
- Updating and checking any live application, and asking GitHub Support to purge the cached old commit, remain pending.
